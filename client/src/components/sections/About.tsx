...
import gif from '../../public/images/img.gif'
...
export default function About() {
  ...
  return (
    <section id="about" className="py-20 bg-dark text-black">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">{t('about.title')}</h2>
            <p className="text-gray-700 mb-6 text-lg">{t('about.story')}</p>
            <p className="text-gray-700 mb-6 text-lg">{t('about.mission')}</p>
